...
const products = {
  ...
  soundsmart: {
    ...
    headline: 'You Think Faster Than You Type. Record Instead.',
    description: 'SoundSmart captures thoughts at the speed of speech. Record voice memos, get instant transcription, AI-powered summaries, and extracted action items. Your brain\'s bandwidth, finally matched by your tools.',
    metaTitle: 'AI Voice Memo App - Transcribe & Summarize | SoundSmart',
    metaDescription: 'Record voice memos, get instant AI transcription and smart summaries with action items. Best AI voice notes app for hands-free productivity.',
    features: [
      'Instant transcription with 99% accuracy',
      'Smart summarization with key points & action items',
      'Speaker identification for multi-person conversations',
      'Offline-first with end-to-end encryption',
      'Search across your entire voice memo library',
      'Export to Markdown, PDF, Notion, Todoist',
    ],
    cta: 'https://soundsmart.appmog.studio',
  },
  vestingwatch: {
    name: 'VestingWatch',
    status: 'LIVE' as const,
  ...
  speaksmart: {
    ...
    metaTitle: 'Voice to Action AI - Real-Time Commands | SpeakSmart',
    ...
    features: [
      'Instant task execution from voice commands',
      'Context-aware multi-turn conversations',
      '50+ integrations (Gmail, Slack, Todoist, GitHub)',
      'Custom voice macros & chained actions',
      'Local-first with E2E encryption option',
